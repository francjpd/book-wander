        ...
        <nav class="grid grid-cols-12 ">
            ...
            <div
                ...
                <template v-else>
                    ...
                    <div class="inline-flex gap-6 col-start-4 col-span-6 justify-center h-full w-full items-center">
                        <NuxtLink :to="'/'" active-class="text-lightning-yellow-500"
                            class="hover:text-lightning-yellow-500 font-semibold transition-colors">Travel</NuxtLink>
                        <NuxtLink active-class="text-lightning-yellow-500" :to="'/booking'"
                            class="hover:text-lightning-yellow-500 font-semibold transition-colors">Booking</NuxtLink>
                    </div>
                </template>
            </div>
        </nav>
        <!-- Mobile Navigation Menu -->
        <div v-if="!isDesktop && showMenu"
