    ...
    <header
        ...
        <div v-if="isMounted && !isDesktop && showMenu"
            ...
            <Button variant="ghost" @click="toggleMenu">
                <NuxtLink :to="'/'" active-class="text-lightning-yellow-600"
                    class="block hover:text-lightning-yellow-600 font-semibold transition-colors">Travel</NuxtLink>
            </Button>
            <Button variant="ghost" @click="toggleMenu">
                <NuxtLink active-class="text-lightning-yellow-600" :to="'/booking'"
                    class="block hover:text-lightning-yellow-600 font-semibold transition-colors">Booking</NuxtLink>
            </Button>
        </div>
    </header>
</template>
